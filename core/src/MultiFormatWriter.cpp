...
#ifdef ZXING_BUILD_AZTEC
	[[maybe_unused]] auto AztecEccLevel = [&](Aztec::Writer& writer, int eccLevel) { writer.setEccPercent(eccLevel * 100 / 8); };
#endif
#ifdef ZXING_BUILD_PDF417
	[[maybe_unused]] auto Pdf417EccLevel = [&](Pdf417::Writer& writer, int eccLevel) { writer.setErrorCorrectionLevel(eccLevel); };
#endif
#ifdef ZXING_BUILD_QR_CODE
	[[maybe_unused]] auto QRCodeEccLevel = [&](QRCode::Writer& writer, int eccLevel) {
